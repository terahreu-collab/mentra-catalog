...
/**
 * ─── 7. ADD course_files COLUMN TO courses TABLE ─────────
 *
 * Stores shared course-level file metadata as a JSON array.
 * Same structure as lesson_files — each entry:
 * {
 *   "filename": "training-guide.pdf",
 *   "url": "https://...supabase.co/storage/v1/object/public/lesson-files/...",
 *   "storagePath": "course_uuid/timestamp_filename.pdf",
 *   "size": 1048576,
 *   "type": "application/pdf",
 *   "note": "Reference material for all lessons in this course",
 *   "uploadedAt": "2026-02-10T12:00:00.000Z"
 * }
 */

const ALTER_COURSES_FILES_SQL = `
ALTER TABLE courses
  ADD COLUMN IF NOT EXISTS course_files jsonb;
`;
 ...
 *                    ↑ also used for course-level shared files
 *
 ...
 *     - course_files    (jsonb)  — stores shared course file metadata as JSON
 *
